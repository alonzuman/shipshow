...
const markdownComponents: Components = {
  ...
  img: ({ ...props }) => {
    return <img {...props} className="mb-2 rounded-lg" />;
  },
  h1: ({ ...props }) => {
    return <h1 {...props} className="text-4xl font-bold mb-4 mt-6" />;
  },
  h2: ({ ...props }) => {
    return <h2 {...props} className="text-2xl font-bold mb-4 mt-6" />;
  },
  h3: ({ ...props }) => {
    return <h3 {...props} className="text-xl font-bold mb-4 mt-6" />;
  },
  h4: ({ ...props }) => {
    return <h4 {...props} className="text-lg font-bold mb-4 mt-6" />;
  },
  h5: ({ ...props }) => {
    return <h5 {...props} className="text-base font-bold mb-4 mt-6" />;
  },
  h6: ({ ...props }) => {
    return <h6 {...props} className="text-sm font-bold mb-4 mt-6" />;
  },
  hr: ({ ...props }) => {
...
export default function Page() {
  ...
  return (
    <div className="p-4 flex flex-col gap-4 max-w-2xl mx-auto" ref={divRef}>
      {!data ? (
        <>
          <h1 className="text-6xl font-bold mb-2 mt-24">Ship Show</h1>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-500">
                  60s brand video + social cutdowns
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0 w-6 h-6">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25l4.72-4.72a.75.75 0 011.28.53v15.94a.75.75 0 01-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.01 9.01 0 012.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25H6.75z"
                  />
                </svg>
              </div>
              <div>
